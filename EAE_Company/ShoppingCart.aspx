<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ShoppingCart.aspx.cs" Inherits="ShoppingCart" %>
            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="goods-page">
                            ...
                            <div class="table-wrapper-responsive">
                                <table summary="Shopping cart">
                                    ...
                                    <tr>
                                        ...
                                        <td class="goods-page-ref-no">javc2133
                    </td>
                        ...
                        <button class="btn btn-primary" id="checkOutBtn" type="submit" onclick="checkOut()">Checkout  <i class="fa fa-check"></i></button>
                    </div>
                </div>
                <script>
                    function checkOut() {
